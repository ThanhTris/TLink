...
import { getPostsByCategory, countPostsHomePopular } from "../api/post";
...
const toDate = (mysqlDate: string): Date => {
...
const Popular: React.FC = () => {
  ...
  // Lấy bài viết phổ biến theo trang
  const fetchPosts = async (page: number) => {
    try {
      ...
      // Gọi API lấy bài viết phổ biến (FE truyền "/popular")
